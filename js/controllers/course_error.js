...
app.controller('course_error', function ($scope, $routeParams) {
    ...
    $scope.gobackCourseAppointment = function()
    {
        window.session.selected_courseappointment = $scope.CourseDetail;
        global['goto']("course_appointment/"+$scope.CourseDetail.CourseBookingID);
    }
    ...
    $scope.cancelBooking = function()
    {
        var param = {
            ...
            _cache: false,
            _param: {
                CourseBookingID: $scope.CourseDetail.CourseBookingID,
        ...
        global.ajax_data($scope, param, function (oData) {
            ...
            $scope.$apply(function () {
                ...
                global['goto']("course_cancel/"+$scope.CourseDetail.CourseBookingID);
            });
        });
    }
